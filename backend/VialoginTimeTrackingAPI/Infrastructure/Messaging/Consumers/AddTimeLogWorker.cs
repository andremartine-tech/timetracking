...
{
    public class AddTimeLogWorker : BackgroundService
    {
        ...
        public AddTimeLogWorker(IServiceProvider serviceProvider, RabbitMqService rabbitMqService, string queueName, int consumerCount = 5)
        {
        ...
        private async void StartConsumer(int consumerId, IChannel channel, CancellationToken stoppingToken)
        {
            ...
            var processMessageRegisterTimeLogUseCase = scope.ServiceProvider.GetRequiredService<IProcessMessageAddTimeLogUseCase>();
