...
{
    public class ProcessMessageAddTimeLogUseCase : IProcessMessageAddTimeLogUseCase
    {

        private readonly ITimeLogRepository _timeLogRepository;

        public ProcessMessageAddTimeLogUseCase(ITimeLogRepository timeLogRepository)
        {
        ...
        public async Task ExecuteAsync(string message, CancellationToken cancellationToken)
        {
            try
            {
                ...
                await _timeLogRepository.AddAsync(newTimeLog);
